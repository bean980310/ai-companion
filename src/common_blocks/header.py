...
class HeaderUIComponent:
    ...
    def create_header_container(cls, render=True):
        ...
        if settings_button.is_rendered:
            if ui_component.settings_button is not None:
                pass
            else:
                ui_component.settings_button = settings_button

        if language_dropdown.is_rendered:
            if ui_component.language_dropdown is not None:
                pass
            else:
    ...
    def create_navbar(cls):
        ...
        if navbar.is_rendered:
            if ui_component.navbar is not None:
                pass
            else:
