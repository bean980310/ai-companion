...
from src.common_blocks import BottomNavUIComponent
...
from src.common.translations import translation_manager, default_language, _
...
with gr.Blocks() as demo:
    ...
    diff_bottom_nav = BottomNavUIComponent()
    with gr.Row():
