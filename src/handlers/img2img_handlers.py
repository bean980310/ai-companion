...
from workflows.load_workflow import load_img2img_workflow, load_img2img_sdxl_workflow, load_img2img_sdxl_with_refiner_workflow, load_img2img_workflow_clip_skip, load_img2img_sdxl_workflow_clip_skip, load_img2img_sdxl_with_refiner_workflow_clip_skip, load_inpaint_workflow, load_inpaint_sdxl_workflow, load_inpaint_sdxl_with_refiner_workflow, load_inpaint_workflow_clip_skip, load_inpaint_sdxl_workflow_clip_skip, load_inpaint_sdxl_with_refiner_workflow_clip_skip
...
def generate_images_to_images(
    ...
    try:
        ...
        prompt["10"]["inputs"]["image"] = input_name
        ...
        if diffusion_model_type == "diffusers":
            ...
            generated = client.image2image_generate(prompt)  # 실제 생성 결과로 대체
...
def generate_images_to_images_with_refiner(
    ...
    try:
        ...
        prompt["14"]["inputs"]["image"] = input_name
