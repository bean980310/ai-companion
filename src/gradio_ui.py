...
with gr.Blocks() as demo:
    ...
    settings_button, model_type_dropdown, model_dropdown, system_message_box, preset_dropdown = main.create_main_container(demo=demo)
    ...
    @ui_component.settings_button.click(outputs=settings_popup)
    ...
    # 설정 변경을 감지하여 상태 업데이트
    for input_component in [ui_component.model_type_dropdown, ui_component.model_dropdown, device_dropdown, ui_component.preset_dropdown, ui_component.system_message_box]:
    ...
    demo.load(
        ...
        outputs=[app_state.session_id_state, app_state.history_state, existing_sessions_dropdown, app_state.character_state, ui_component.preset_dropdown, app_state.system_message_state, current_session_display],
        queue=False
    )
