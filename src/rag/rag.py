...
# 언어 이름과 코드 매핑 딕셔너리
LANGUAGE_MAP = {"한국어": "ko", "日本語": "ja", "简体中文": "zh_CN", "繁體中文": "zh_TW", "English": "en"}
...
def process_document(doc):
    ...
    for section_title, section_content in sections:
        new_doc = Document(page_content=section_content, metadata={"language": lang_code, "section": section_title, "source": doc.metadata.get("source", "unknown")})
