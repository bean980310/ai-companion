...
from workflows.load_workflow import load_txt2img_workflow, load_txt2img_sdxl_workflow, load_txt2img_sdxl_with_refiner_workflow
...
def generate_images(
    ...
    try:
        ...
        if vae == "Default":
            ...
            base_node = new_node_id
            current_node_id += 1
            prompt["8"]["inputs"]["vae"] = [base_node, 2]
...
def generate_images_with_refiner(
    ...
    try:
        ...
        # prompt["11"]["inputs"]["clip"] = [refiner_base_node, 1]
        # prompt["12"]["inputs"]["clip"] = [refiner_base_node, 1]
...
def generate_images_wrapper(positive_prompt, negative_prompt, style, generation_step, diffusion_refiner_start, width, height,
    diffusion_model, diffusion_refiner_model, diffusion_model_type, lora_multiselect, vae, clip_skip, clip_g, sampler, scheduler,
