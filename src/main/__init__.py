...
def create_main_container(demo: gr.Blocks):
    with gr.Column(elem_classes="main-container"):
        ...
        (
            ...
            diff_side,
            storyteller_side,
            storytelling_model_type_dropdown,
            storytelling_model_dropdown,
            storytelling_api_key_text,
            storytelling_lora_dropdown,
            tts_side,
            tts_model_type_dropdown,
            tts_model_dropdown,
            translate_side,
        ) = create_sidebar()
        ...
        (
            ...
            storytelling_output,
            story_adv_setting,
            storyteller_seed_input,
            storyteller_temperature_slider,
            storyteller_top_k_slider,
            storyteller_top_p_slider,
            storyteller_repetition_penalty_slider,
            tts_container,
            translate_container,
            download_container,
    ...
    def process_uploaded_image_for_inpaint(image: str | Image.Image | Any):
        print(image)
        im = {"background": image, "layers": [], "composite": None}
        image = client.upload_image(image, overwrite=True)
    ...
    @gr.on(
        triggers=[chatbot_sidetab.click, demo.load],
        inputs=[],
        outputs=[
            chat_side.sidebar,
            diff_side.sidebar,
    ...
    def select_chat_tab():
        return (
            ...
            gr.update(visible=False),
            gr.update(visible=False),
            gr.update(elem_classes="tab-active"),
            gr.update(elem_classes="tab"),
            gr.update(elem_classes="tab"),
            gr.update(elem_classes="tab"),
            gr.update(elem_classes="tab"),
            gr.update(elem_classes="tab"),
