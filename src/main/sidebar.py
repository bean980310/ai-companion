...
def create_sidebar():
    with gr.Sidebar(elem_classes="sidebar-container") as sidebar:
        tab_side, llm_integrated_sidetab, chatbot_sidetab, diffusion_sidetab, storyteller_sidetab, tts_sidetab, translate_sidetab, download_sidetab = create_tab_side()
    ...
    return [
        sidebar, tab_side, llm_integrated_sidetab, chatbot_sidetab, diffusion_sidetab, storyteller_sidetab, tts_sidetab, translate_sidetab, download_sidetab,
