...
uv pip install https://github.com/JamePeng/llama-cpp-python/releases/download/v0.3.17-cu128-AVX2-win-20251121/llama_cpp_python-0.3.17-cp312-cp312-win_amd64.whl
